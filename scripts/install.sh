...
if [[ -f "${ROOT}/scripts/ensure-env-license-key.sh" ]]; then
...
echo
echo "================================================================"
echo "TEMPORARY DEFAULT ADMIN CREDENTIALS (first fresh install only)"
echo "================================================================"
echo "  Email:    admin@dbhr.local"
echo "  Password: ChangeMe@12345"
echo
echo "SECURITY REMINDER:"
echo "  Change this password immediately after your first login."
echo "  The application will require a password change before normal use."
echo "================================================================"
