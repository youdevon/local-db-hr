...
function formatSystemActionLabel(value: string | null | undefined): string {
  ...
  const known: Record<string, string> = {
    ...
    created_default_admin: "Created Default Administrator",
    default_admin_first_login: "Default Admin First Login",
    default_admin_password_changed: "Default Admin Password Changed",
