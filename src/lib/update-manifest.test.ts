...
const validManifest = {
  ...
  latestVersion: "0.12.0-beta",
  releaseTag: "v0.12.0-beta",
  releaseDate: "2026-05-09",
  updateChannel: "beta",
  minimumSupportedVersion: "0.11.0-beta",
  requiresDatabaseMigration: true,
  requiresDockerRebuild: true,
  releaseUrl: "https://github.com/youdevon/local-db-hr/releases/tag/v0.12.0-beta",
  downloadUrl: "https://github.com/youdevon/local-db-hr/archive/refs/tags/v0.12.0-beta.zip",
  notes: ["Note a", "Note b"],
};
...
describe("validateUpdateManifestJson", () => {
  it("accepts a well-formed manifest", () => {
    ...
    if (r.ok) expect(r.manifest.latestVersion).toBe("0.12.0-beta");
  });
...
describe("buildUpdateCheckResult", () => {
  it("marks update available when latest is newer", () => {
    ...
    expect(body.latestVersion).toBe("0.12.0-beta");
